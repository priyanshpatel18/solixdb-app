...
export function ApiExamplesSection() {
  ...
  return (
    <section id="api" className="">
      <div className="flex flex-col gap-4 sm:gap-8 mt-16 sm:mt-24 md:mt-36 px-4 sm:px-8 md:px-16 lg:px-30">
        <span className="text-2xl sm:text-3xl md:text-4xl text-neutral-400 font-semibold"># API's</span>
